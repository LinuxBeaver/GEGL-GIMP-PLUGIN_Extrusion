...
/*GEGL Bevel is a stand alone plugin but it is also part of Graphical Effects. The stand alone version does more then the Graphical Effects implementation of it. */
